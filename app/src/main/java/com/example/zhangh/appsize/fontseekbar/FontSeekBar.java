...
/**
 * Created by zhanghui on 2018/10/16.
 */
...
public class FontSeekBar extends View {
    ...
    public FontSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FontSeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public FontSeekBar setOnSliderBarChangeListener(OnSliderBarChangeListener listener) {
        mListener = listener;
        return FontSeekBar.this;
    }

    public FontSeekBar setTickCount(int tickCount) {
    ...
    public FontSeekBar setTickHeight(float tickHeight) {
        mTickHeight = tickHeight;
        return FontSeekBar.this;
    }

    public FontSeekBar setBarWeight(float barWeight) {
        mBarWidth = barWeight;
        return FontSeekBar.this;
    }

    public FontSeekBar setBarColor(int barColor) {
        mBarColor = barColor;
        return FontSeekBar.this;
    }

    public FontSeekBar setTextSize(int textSize) {
        mTextSize = textSize;
        return FontSeekBar.this;
    }

    public FontSeekBar setTextColor(int textColor) {
        mTextColor = textColor;
        return FontSeekBar.this;
    }

    public FontSeekBar setTextPadding(int textPadding) {
        mTextPadding = textPadding;
        return FontSeekBar.this;
    }

    public FontSeekBar setThumbRadius(float thumbRadius) {
        mThumbRadius = thumbRadius;
        return FontSeekBar.this;
    }

    public FontSeekBar setThumbColorNormal(int thumbColorNormal) {
        mThumbColorNormal = thumbColorNormal;
        return FontSeekBar.this;
    }

    public FontSeekBar setThumbColorPressed(int thumbColorPressed) {
        mThumbColorPressed = thumbColorPressed;
        return FontSeekBar.this;
    }


    public FontSeekBar setThumbIndex(int currentIndex) {
        //处理越界
...
//                    "A thumb index is out of bounds. Check that it is between 0 and mTickCount - 1");
    ...
    public FontSeekBar withAnimation(boolean animation) {
...
//            mThumb = new Thumb(getXCoordinate()+getBarLength()/(mTickCount-1)*mCurrentIndex-4, getYCoordinate(), mThumbColorNormal, mThumbColorPressed, mThumbRadius);
            mThumb = new Thumb(getXCoordinate()+getBarLength()/(mTickCount-1)*mCurrentIndex, getYCoordinate(), mThumbColorNormal, mThumbColorPressed, mThumbRadius);
        }
...
//        mThumb = new Thumb(xCoordinate, getYCoordinate(), mThumbColorNormal, mThumbColorPressed, mThumbRadius);
    ...
    public interface OnSliderBarChangeListener {
         void onIndexChanged(FontSeekBar rangeBar, int index);
    }
}
